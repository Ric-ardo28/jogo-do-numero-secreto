...
function exiberMensagemInicial(){
  ...
  exiberTextoNaTela('p', 'Escolha um numero entre 1 e 250');
}
...
function verificarChute() {
    ...
    let palavraTentativas = tentativas > 1 ? 'tentativas' : 'tetativa';
    ...
    document.getElementById('reiniciar').removeAttribute('disabled');
      ...
      if(chute > numeroSecreto){
        exiberTextoNaTela('p', 'o numero secreto é menor');
      }else{
        exiberTextoNaTela('p', 'o numero secreto é maior');
      }
      tentativas++;
      limparCampo()
